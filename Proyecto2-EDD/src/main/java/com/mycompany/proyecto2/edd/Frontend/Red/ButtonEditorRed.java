 ...
 * @author alesso
 */
public class ButtonEditorRed extends DefaultCellEditor {
    ...
    public ButtonEditorRed(JCheckBox checkBox, DefaultTableModel modeloRedes, SistemaBiblioteca sistema) {
        super(checkBox);
        button = new JButton();
